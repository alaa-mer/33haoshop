...
function write_file($filepath, $data, $mode = null)
{
    ...
    $data = "<?php defined('intexh_shop') or exit('Access Invalid!'); return ".$data.";";
...
if ( ! function_exists('get_config'))
{
	function &get_config($replace = array())
	{
		...
		$file_path = BASE_DATA_PATH.'/config/config.ini.php';
		if (!@include_once($file_path)){
			exit("Class Error: {config.ini.php}.isn't exists!");
		}
