...
function runquery($sql) {
	...
	$sql = str_replace("\r", "\n", str_replace('shopsx_', $tablepre, $sql));
	$ret = array();
	$num = 0;
	foreach(explode(";\n", trim($sql)) as $query) {
		$ret[$num] = '';
...
<meta content="随行商城" name="Copyright" />
</head>
	<div class="header">
      <div class="layout">
        <div class="title">
	...
	<table class="menu" align="center">
			<tr class="menu_tr">
				...
				<?php if ($current == ''){ ?>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;如果你的版本里未安装www.intexh.com模块！你只需简单一步就可以安装好随行商城插件！感谢你对随行商城的支持！<span style="color: #FF0000;">如因安装造成您原有二次开发功能的错误或丢失，www.intexh.com不予承担任何责任及损失，请您慎重操作。
				</span><br /><br />
			  ...
			  <div>
			  	...
			  	2、&nbsp;&nbsp;本模板只用于学习交流使用。无论您是个人组织、盈利与否、用途如何（包括以学习和研究为目的），均与随行商城无关！<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;随行商城只提供相关技术服务！不负责任何商业责任！还请知悉。<br />
			  	3、&nbsp;&nbsp;随行商城官方论坛：http://www.intexh.com<br />
...
<div class="footer">
  <h5><a href="http://www.intexh.com" target="_blank">随行商城-intexh.com 提供</a></h6>
</div>
<script type="text/javascript">
<?php if ($_GET['go'] == '3'){ ?>
