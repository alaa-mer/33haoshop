...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='买家地址信息表';
...
CREATE TABLE `shop_admin_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=157 DEFAULT CHARSET=utf8 COMMENT='管理员操作日志';
...
CREATE TABLE `shop_album_pic` (
  ...
  `upload_time` int(10) unsigned NOT NULL COMMENT '图片上传时间',
  PRIMARY KEY (`apic_id`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='相册图片表';

DROP TABLE IF EXISTS `shop_apiseccode`;
CREATE TABLE `shop_apiseccode` (
...
DROP TABLE IF EXISTS `shop_arrival_notice`;
CREATE TABLE `shop_arrival_notice` (
...
DROP TABLE IF EXISTS `shop_bill_create`;
CREATE TABLE `shop_bill_create` (
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='购物车数据表';

DROP TABLE IF EXISTS `shop_chain`;
...
DROP TABLE IF EXISTS `shop_chain_stock`;
CREATE TABLE `shop_chain_stock` (
...
DROP TABLE IF EXISTS `shop_chat_log`;
CREATE TABLE `shop_chat_log` (
...
DROP TABLE IF EXISTS `shop_chat_msg`;
CREATE TABLE `shop_chat_msg` (
  `m_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '记录ID',
  `f_id` int(10) unsigned NOT NULL COMMENT '会员ID',
  `f_name` varchar(50) NOT NULL COMMENT '会员名',
  `f_ip` varchar(15) NOT NULL COMMENT '发自IP',
...
DROP TABLE IF EXISTS `shop_circle`;
CREATE TABLE `shop_circle` (
...
DROP TABLE IF EXISTS `shop_circle_affix`;
CREATE TABLE `shop_circle_affix` (
...
DROP TABLE IF EXISTS `shop_circle_class`;
CREATE TABLE `shop_circle_class` (
...
DROP TABLE IF EXISTS `shop_circle_explog`;
CREATE TABLE `shop_circle_explog` (
...
DROP TABLE IF EXISTS `shop_circle_expmember`;
CREATE TABLE `shop_circle_expmember` (
...
DROP TABLE IF EXISTS `shop_circle_exptheme`;
CREATE TABLE `shop_circle_exptheme` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '主题id',
...
DROP TABLE IF EXISTS `shop_circle_fs`;
CREATE TABLE `shop_circle_fs` (
  `circle_id` int(11) unsigned NOT NULL COMMENT '圈子id',
...
DROP TABLE IF EXISTS `shop_circle_inform`;
CREATE TABLE `shop_circle_inform` (
...
DROP TABLE IF EXISTS `shop_circle_like`;
CREATE TABLE `shop_circle_like` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '主题id',
  `member_id` int(11) unsigned NOT NULL COMMENT '会员id',
  `circle_id` int(11) unsigned NOT NULL COMMENT '圈子id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='主题赞表';

DROP TABLE IF EXISTS `shop_circle_mapply`;
CREATE TABLE `shop_circle_mapply` (
...
DROP TABLE IF EXISTS `shop_circle_member`;
CREATE TABLE `shop_circle_member` (
  `member_id` int(11) unsigned NOT NULL COMMENT '会员id',
  `circle_id` int(11) unsigned NOT NULL COMMENT '圈子id',
...
DROP TABLE IF EXISTS `shop_circle_ml`;
CREATE TABLE `shop_circle_ml` (
  `circle_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '圈子id',
...
DROP TABLE IF EXISTS `shop_circle_mldefault`;
CREATE TABLE `shop_circle_mldefault` (
...
DROP TABLE IF EXISTS `shop_circle_mlref`;
CREATE TABLE `shop_circle_mlref` (
...
DROP TABLE IF EXISTS `shop_circle_recycle`;
CREATE TABLE `shop_circle_recycle` (
...
DROP TABLE IF EXISTS `shop_circle_thclass`;
CREATE TABLE `shop_circle_thclass` (
...
DROP TABLE IF EXISTS `shop_circle_theme`;
CREATE TABLE `shop_circle_theme` (
...
DROP TABLE IF EXISTS `shop_circle_thg`;
CREATE TABLE `shop_circle_thg` (
...
DROP TABLE IF EXISTS `shop_circle_thpoll`;
CREATE TABLE `shop_circle_thpoll` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '话题id',
...
DROP TABLE IF EXISTS `shop_circle_thpolloption`;
CREATE TABLE `shop_circle_thpolloption` (
...
DROP TABLE IF EXISTS `shop_circle_thpollvoter`;
CREATE TABLE `shop_circle_thpollvoter` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '话题id',
  `member_id` int(11) unsigned NOT NULL COMMENT '成员id',
  `member_name` varchar(50) NOT NULL COMMENT '成员名称',
...
DROP TABLE IF EXISTS `shop_circle_threply`;
CREATE TABLE `shop_circle_threply` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '主题id',
...
DROP TABLE IF EXISTS `shop_cms_article`;
CREATE TABLE `shop_cms_article` (
...
DROP TABLE IF EXISTS `shop_cms_article_attitude`;
CREATE TABLE `shop_cms_article_attitude` (
...
DROP TABLE IF EXISTS `shop_cms_article_class`;
CREATE TABLE `shop_cms_article_class` (
  ...
  PRIMARY KEY (`class_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='cms文章分类表';

DROP TABLE IF EXISTS `shop_cms_comment`;
CREATE TABLE `shop_cms_comment` (
...
DROP TABLE IF EXISTS `shop_cms_comment_up`;
CREATE TABLE `shop_cms_comment_up` (
...
DROP TABLE IF EXISTS `shop_cms_index_module`;
CREATE TABLE `shop_cms_index_module` (
...
DROP TABLE IF EXISTS `shop_cms_module`;
CREATE TABLE `shop_cms_module` (
...
DROP TABLE IF EXISTS `shop_cms_module_assembly`;
CREATE TABLE `shop_cms_module_assembly` (
...
DROP TABLE IF EXISTS `shop_cms_module_frame`;
CREATE TABLE `shop_cms_module_frame` (
...
DROP TABLE IF EXISTS `shop_cms_navigation`;
CREATE TABLE `shop_cms_navigation` (
...
DROP TABLE IF EXISTS `shop_cms_picture`;
CREATE TABLE `shop_cms_picture` (
...
DROP TABLE IF EXISTS `shop_cms_picture_class`;
CREATE TABLE `shop_cms_picture_class` (
  `class_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类编号 ',
  `class_name` varchar(50) NOT NULL COMMENT '分类名称',
  `class_sort` tinyint(1) unsigned NOT NULL DEFAULT '255' COMMENT '排序',
  PRIMARY KEY (`class_id`)
...
DROP TABLE IF EXISTS `shop_cms_picture_image`;
CREATE TABLE `shop_cms_picture_image` (
...
DROP TABLE IF EXISTS `shop_cms_special`;
CREATE TABLE `shop_cms_special` (
...
DROP TABLE IF EXISTS `shop_cms_tag`;
CREATE TABLE `shop_cms_tag` (
  ...
  PRIMARY KEY (`tag_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='CMS标签表';

DROP TABLE IF EXISTS `shop_cms_tag_relation`;
CREATE TABLE `shop_cms_tag_relation` (
...
DROP TABLE IF EXISTS `shop_consult_type`;
CREATE TABLE `shop_consult_type` (
...
DROP TABLE IF EXISTS `shop_contract_apply`;
CREATE TABLE `shop_contract_apply` (
...
DROP TABLE IF EXISTS `shop_contract_costlog`;
CREATE TABLE `shop_contract_costlog` (
...
DROP TABLE IF EXISTS `shop_contract_item`;
CREATE TABLE `shop_contract_item` (
...
DROP TABLE IF EXISTS `shop_contract_log`;
CREATE TABLE `shop_contract_log` (
...
DROP TABLE IF EXISTS `shop_contract_quitapply`;
CREATE TABLE `shop_contract_quitapply` (
...
CREATE TABLE `shop_cron` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='任务队列表';
...
DROP TABLE IF EXISTS `shop_delivery_point`;
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='信誉评价表';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='店铺评分表';

DROP TABLE IF EXISTS `shop_exppoints_log`;
CREATE TABLE `shop_exppoints_log` (
  ...
  PRIMARY KEY (`exp_id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='经验值日志表';
...
DROP TABLE IF EXISTS `shop_flowstat`;
CREATE TABLE `shop_flowstat` (
...
DROP TABLE IF EXISTS `shop_flowstat_1`;
CREATE TABLE `shop_flowstat_1` (
  `stattime` int(11) unsigned NOT NULL COMMENT '访问日期',
  `clicknum` int(11) unsigned NOT NULL COMMENT '访问量',
  `store_id` int(11) unsigned NOT NULL COMMENT '店铺ID',
  `type` varchar(10) NOT NULL COMMENT '类型',
...
DROP TABLE IF EXISTS `shop_flowstat_2`;
CREATE TABLE `shop_flowstat_2` (
  `stattime` int(11) unsigned NOT NULL COMMENT '访问日期',
  `clicknum` int(11) unsigned NOT NULL COMMENT '访问量',
  `store_id` int(11) unsigned NOT NULL COMMENT '店铺ID',
  `type` varchar(10) NOT NULL COMMENT '类型',
...
) ENGINE=InnoDB AUTO_INCREMENT=100016 DEFAULT CHARSET=utf8 COMMENT='商品表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1059 DEFAULT CHARSET=utf8 COMMENT='商品分类表';

DROP TABLE IF EXISTS `shop_goods_class_nav`;
CREATE TABLE `shop_goods_class_nav` (
...
) ENGINE=InnoDB AUTO_INCREMENT=100016 DEFAULT CHARSET=utf8 COMMENT='商品公共内容表';

DROP TABLE IF EXISTS `shop_goods_fcode`;
CREATE TABLE `shop_goods_fcode` (
  ...
  PRIMARY KEY (`fc_id`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8 COMMENT='商品F码';

DROP TABLE IF EXISTS `shop_goods_gift`;
CREATE TABLE `shop_goods_gift` (
  ...
  PRIMARY KEY (`gift_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='商品赠品表';
...
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='商品图片';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='商品推荐表';

DROP TABLE IF EXISTS `shop_groupbuy`;
CREATE TABLE `shop_groupbuy` (
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='抢购商品表';
...
CREATE TABLE `shop_groupbuy_class` (
  ...
  PRIMARY KEY (`class_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='抢购类别表';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='抢购价格区间表';

DROP TABLE IF EXISTS `shop_groupbuy_quota`;
CREATE TABLE `shop_groupbuy_quota` (
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='抢购套餐表';
...
DROP TABLE IF EXISTS `shop_help_type`;
CREATE TABLE `shop_help_type` (
...
CREATE TABLE `shop_invoice` (
  ...
  PRIMARY KEY (`inv_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='买家发票信息表';
...
DROP TABLE IF EXISTS `shop_mail_cron`;
CREATE TABLE `shop_mail_cron` (
...
DROP TABLE IF EXISTS `shop_mall_consult`;
CREATE TABLE `shop_mall_consult` (
...
DROP TABLE IF EXISTS `shop_mall_consult_type`;
CREATE TABLE `shop_mall_consult_type` (
...
DROP TABLE IF EXISTS `shop_mb_category`;
CREATE TABLE `shop_mb_category` (
...
DROP TABLE IF EXISTS `shop_mb_feedback`;
CREATE TABLE `shop_mb_feedback` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `shop_mb_payment`;
CREATE TABLE `shop_mb_payment` (
...
DROP TABLE IF EXISTS `shop_mb_seller_token`;
CREATE TABLE `shop_mb_seller_token` (
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='客户端商家登录令牌表';

DROP TABLE IF EXISTS `shop_mb_special`;
CREATE TABLE `shop_mb_special` (
  `special_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '专题编号',
  `special_desc` varchar(20) NOT NULL COMMENT '专题描述',
  PRIMARY KEY (`special_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='手机专题表';

DROP TABLE IF EXISTS `shop_mb_special_item`;
CREATE TABLE `shop_mb_special_item` (
  ...
  PRIMARY KEY (`item_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='手机专题项目表';

DROP TABLE IF EXISTS `shop_mb_user_token`;
CREATE TABLE `shop_mb_user_token` (
  `token_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '令牌编号',
  `member_id` int(10) unsigned NOT NULL COMMENT '用户编号',
  `member_name` varchar(50) NOT NULL COMMENT '用户名',
  `token` varchar(50) NOT NULL COMMENT '登录令牌',
  ...
  PRIMARY KEY (`token_id`)
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8 COMMENT='移动端登录令牌表';
...
DROP TABLE IF EXISTS `shop_member_common`;
CREATE TABLE `shop_member_common` (
  `member_id` int(11) NOT NULL COMMENT '会员ID',
...
DROP TABLE IF EXISTS `shop_member_msg_setting`;
CREATE TABLE `shop_member_msg_setting` (
...
DROP TABLE IF EXISTS `shop_member_msg_tpl`;
CREATE TABLE `shop_member_msg_tpl` (
  `mmt_code` varchar(50) NOT NULL COMMENT '用户消息模板编号',
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='短消息';

DROP TABLE IF EXISTS `shop_micro_adv`;
CREATE TABLE `shop_micro_adv` (
  ...
  PRIMARY KEY (`adv_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='微商城广告表';

DROP TABLE IF EXISTS `shop_micro_comment`;
CREATE TABLE `shop_micro_comment` (
  `comment_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '评论编号',
  `comment_type` tinyint(1) NOT NULL COMMENT '评论类型编号',
  `comment_object_id` int(10) unsigned NOT NULL COMMENT '推荐商品编号',
...
DROP TABLE IF EXISTS `shop_micro_goods`;
CREATE TABLE `shop_micro_goods` (
...
DROP TABLE IF EXISTS `shop_micro_goods_class`;
CREATE TABLE `shop_micro_goods_class` (
...
DROP TABLE IF EXISTS `shop_micro_goods_relation`;
CREATE TABLE `shop_micro_goods_relation` (
  `relation_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '关系编号',
...
DROP TABLE IF EXISTS `shop_micro_like`;
CREATE TABLE `shop_micro_like` (
...
DROP TABLE IF EXISTS `shop_micro_member_info`;
CREATE TABLE `shop_micro_member_info` (
...
DROP TABLE IF EXISTS `shop_micro_personal`;
CREATE TABLE `shop_micro_personal` (
...
DROP TABLE IF EXISTS `shop_micro_personal_class`;
CREATE TABLE `shop_micro_personal_class` (
  `class_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类编号 ',
  `class_name` varchar(50) NOT NULL COMMENT '分类名称',
  `class_sort` tinyint(4) unsigned NOT NULL COMMENT '排序',
  `class_image` varchar(100) DEFAULT '' COMMENT '分类图片',
...
DROP TABLE IF EXISTS `shop_micro_store`;
CREATE TABLE `shop_micro_store` (
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='微商城店铺街表';
...
CREATE TABLE `shop_navigation` (
  ...
  PRIMARY KEY (`nav_id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='页面导航表';
...
DROP TABLE IF EXISTS `shop_order_book`;
CREATE TABLE `shop_order_book` (
...
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='订单商品表';
...
CREATE TABLE `shop_order_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='订单处理历史表';
...
CREATE TABLE `shop_order_pay` (
  ...
  PRIMARY KEY (`pay_id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='订单支付表';

DROP TABLE IF EXISTS `shop_order_snapshot`;
CREATE TABLE `shop_order_snapshot` (
...
DROP TABLE IF EXISTS `shop_p_book_quota`;
CREATE TABLE `shop_p_book_quota` (
  ...
  PRIMARY KEY (`bkq_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='预定商品套餐表';

DROP TABLE IF EXISTS `shop_p_booth_goods`;
CREATE TABLE `shop_p_booth_goods` (
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='展位商品表';

DROP TABLE IF EXISTS `shop_p_booth_quota`;
CREATE TABLE `shop_p_booth_quota` (
...
DROP TABLE IF EXISTS `shop_p_bundling`;
CREATE TABLE `shop_p_bundling` (
...
DROP TABLE IF EXISTS `shop_p_bundling_goods`;
CREATE TABLE `shop_p_bundling_goods` (
...
DROP TABLE IF EXISTS `shop_p_bundling_quota`;
CREATE TABLE `shop_p_bundling_quota` (
...
DROP TABLE IF EXISTS `shop_p_combo_goods`;
CREATE TABLE `shop_p_combo_goods` (
  ...
  PRIMARY KEY (`cg_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='商品推荐组合表';

DROP TABLE IF EXISTS `shop_p_combo_quota`;
CREATE TABLE `shop_p_combo_quota` (
  ...
  PRIMARY KEY (`cq_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='推荐组合套餐表';

DROP TABLE IF EXISTS `shop_p_cou`;
CREATE TABLE `shop_p_cou` (
...
DROP TABLE IF EXISTS `shop_p_cou_level`;
CREATE TABLE `shop_p_cou_level` (
...
DROP TABLE IF EXISTS `shop_p_cou_level_sku`;
CREATE TABLE `shop_p_cou_level_sku` (
  `cou_id` int(11) NOT NULL COMMENT '加价购ID',
  `xlevel` tinyint(3) unsigned NOT NULL COMMENT '等级',
...
DROP TABLE IF EXISTS `shop_p_cou_quota`;
CREATE TABLE `shop_p_cou_quota` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `store_id` int(11) NOT NULL COMMENT '店铺ID',
  `store_name` varchar(50) NOT NULL COMMENT '店铺名称',
  `tstart` int(10) unsigned NOT NULL COMMENT '开始时间',
...
DROP TABLE IF EXISTS `shop_p_cou_sku`;
CREATE TABLE `shop_p_cou_sku` (
  `sku_id` int(11) NOT NULL COMMENT '商品条目ID',
  `cou_id` int(11) NOT NULL COMMENT '加价购ID',
  `tstart` int(10) unsigned NOT NULL COMMENT '开始时间',
  `tend` int(10) unsigned NOT NULL COMMENT '结束时间',
...
DROP TABLE IF EXISTS `shop_p_fcode_quota`;
CREATE TABLE `shop_p_fcode_quota` (
  ...
  PRIMARY KEY (`fcq_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='F码商品套餐表';
...
CREATE TABLE `shop_p_mansong_rule` (
  ...
  PRIMARY KEY (`rule_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='满就送活动规则表';

DROP TABLE IF EXISTS `shop_p_sole_goods`;
CREATE TABLE `shop_p_sole_goods` (
...
DROP TABLE IF EXISTS `shop_p_sole_quota`;
CREATE TABLE `shop_p_sole_quota` (
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='手机专享套餐表';

DROP TABLE IF EXISTS `shop_p_xianshi`;
CREATE TABLE `shop_p_xianshi` (
...
DROP TABLE IF EXISTS `shop_p_xianshi_goods`;
CREATE TABLE `shop_p_xianshi_goods` (
...
DROP TABLE IF EXISTS `shop_p_xianshi_quota`;
CREATE TABLE `shop_p_xianshi_quota` (
...
CREATE TABLE `shop_pd_log` (
  ...
  PRIMARY KEY (`lg_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='预存款变更日志表';
...
CREATE TABLE `shop_points_log` (
  ...
  PRIMARY KEY (`pl_id`)
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8 COMMENT='会员积分日志表';
...
DROP TABLE IF EXISTS `shop_rcb_log`;
CREATE TABLE `shop_rcb_log` (
...
DROP TABLE IF EXISTS `shop_rechargecard`;
CREATE TABLE `shop_rechargecard` (
...
DROP TABLE IF EXISTS `shop_redpacket`;
CREATE TABLE `shop_redpacket` (
...
DROP TABLE IF EXISTS `shop_redpacket_template`;
CREATE TABLE `shop_redpacket_template` (
...
DROP TABLE IF EXISTS `shop_refund_detail`;
CREATE TABLE `shop_refund_detail` (
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='卖家用户表';
...
DROP TABLE IF EXISTS `shop_seller_group_bclass`;
CREATE TABLE `shop_seller_group_bclass` (
...
CREATE TABLE `shop_seller_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB AUTO_INCREMENT=57 DEFAULT CHARSET=utf8 COMMENT='卖家日志表';
...
DROP TABLE IF EXISTS `shop_signin`;
CREATE TABLE `shop_signin` (
...
DROP TABLE IF EXISTS `shop_sms_log`;
CREATE TABLE `shop_sms_log` (
  `log_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '记录ID',
...
DROP TABLE IF EXISTS `shop_sns_albumclass`;
CREATE TABLE `shop_sns_albumclass` (
  ...
  PRIMARY KEY (`ac_id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='相册表';

DROP TABLE IF EXISTS `shop_sns_albumpic`;
CREATE TABLE `shop_sns_albumpic` (
...
DROP TABLE IF EXISTS `shop_sns_binding`;
CREATE TABLE `shop_sns_binding` (
...
DROP TABLE IF EXISTS `shop_sns_comment`;
CREATE TABLE `shop_sns_comment` (
...
DROP TABLE IF EXISTS `shop_sns_friend`;
CREATE TABLE `shop_sns_friend` (
...
DROP TABLE IF EXISTS `shop_sns_goods`;
CREATE TABLE `shop_sns_goods` (
...
DROP TABLE IF EXISTS `shop_sns_membertag`;
CREATE TABLE `shop_sns_membertag` (
...
DROP TABLE IF EXISTS `shop_sns_mtagmember`;
CREATE TABLE `shop_sns_mtagmember` (
...
DROP TABLE IF EXISTS `shop_sns_setting`;
CREATE TABLE `shop_sns_setting` (
  `member_id` int(11) NOT NULL COMMENT '会员id',
  `setting_skin` varchar(50) DEFAULT NULL COMMENT '皮肤',
  PRIMARY KEY (`member_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='个人中心设置表';

DROP TABLE IF EXISTS `shop_sns_sharegoods`;
CREATE TABLE `shop_sns_sharegoods` (
...
DROP TABLE IF EXISTS `shop_sns_sharestore`;
CREATE TABLE `shop_sns_sharestore` (
  `share_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
...
DROP TABLE IF EXISTS `shop_sns_tracelog`;
CREATE TABLE `shop_sns_tracelog` (
...
DROP TABLE IF EXISTS `shop_sns_visitor`;
CREATE TABLE `shop_sns_visitor` (
...
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8 COMMENT='会员相关数据统计';

DROP TABLE IF EXISTS `shop_stat_order`;
CREATE TABLE `shop_stat_order` (
  `order_id` int(11) NOT NULL COMMENT '订单id',
  `order_sn` bigint(20) unsigned NOT NULL COMMENT '订单编号',
...
DROP TABLE IF EXISTS `shop_stat_ordergoods`;
CREATE TABLE `shop_stat_ordergoods` (
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='店铺数据表';
...
CREATE TABLE `shop_store_bind_class` (
  ...
  PRIMARY KEY (`bid`),
  KEY `store_id` (`store_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='店铺可发布商品类目表';
...
CREATE TABLE `shop_store_cost` (
  ...
  PRIMARY KEY (`cost_id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='店铺费用表';

DROP TABLE IF EXISTS `shop_store_decoration`;
CREATE TABLE `shop_store_decoration` (
...
DROP TABLE IF EXISTS `shop_store_decoration_album`;
CREATE TABLE `shop_store_decoration_album` (
  `image_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '图片编号',
...
DROP TABLE IF EXISTS `shop_store_decoration_block`;
CREATE TABLE `shop_store_decoration_block` (
...
DROP TABLE IF EXISTS `shop_store_distribution`;
CREATE TABLE `shop_store_distribution` (
...
CREATE TABLE `shop_store_goods_class` (
  ...
  KEY `store_id` (`store_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='店铺商品分类表';
...
DROP TABLE IF EXISTS `shop_store_map`;
CREATE TABLE `shop_store_map` (
...
DROP TABLE IF EXISTS `shop_store_msg`;
CREATE TABLE `shop_store_msg` (
  ...
  PRIMARY KEY (`sm_id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='店铺消息表';

DROP TABLE IF EXISTS `shop_store_msg_read`;
CREATE TABLE `shop_store_msg_read` (
...
DROP TABLE IF EXISTS `shop_store_msg_setting`;
CREATE TABLE `shop_store_msg_setting` (
  `smt_code` varchar(100) NOT NULL COMMENT '模板编码',
  `store_id` int(10) unsigned NOT NULL COMMENT '店铺id',
...
DROP TABLE IF EXISTS `shop_store_msg_tpl`;
CREATE TABLE `shop_store_msg_tpl` (
  `smt_code` varchar(100) NOT NULL COMMENT '模板编码',
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='关联板式表';

DROP TABLE IF EXISTS `shop_store_reopen`;
CREATE TABLE `shop_store_reopen` (
...
DROP TABLE IF EXISTS `shop_store_supplier`;
CREATE TABLE `shop_store_supplier` (
...
DROP TABLE IF EXISTS `shop_store_waybill`;
CREATE TABLE `shop_store_waybill` (
...
CREATE TABLE `shop_transport_extend` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='运费模板扩展表';
...
DROP TABLE IF EXISTS `shop_type_custom`;
CREATE TABLE `shop_type_custom` (
  `custom_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '自定义属性id',
  `custom_name` varchar(50) NOT NULL COMMENT '自定义属性名称',
  `type_id` int(10) unsigned NOT NULL COMMENT '类型id',
  PRIMARY KEY (`custom_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='自定义属性表';
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='代金券表';
...
DROP TABLE IF EXISTS `shop_voucher_quota`;
CREATE TABLE `shop_voucher_quota` (
...
DROP TABLE IF EXISTS `shop_vr_groupbuy_area`;
CREATE TABLE `shop_vr_groupbuy_area` (
...
DROP TABLE IF EXISTS `shop_vr_groupbuy_class`;
CREATE TABLE `shop_vr_groupbuy_class` (
...
DROP TABLE IF EXISTS `shop_vr_order`;
CREATE TABLE `shop_vr_order` (
...
DROP TABLE IF EXISTS `shop_vr_order_bill`;
CREATE TABLE `shop_vr_order_bill` (
...
DROP TABLE IF EXISTS `shop_vr_order_code`;
CREATE TABLE `shop_vr_order_code` (
...
DROP TABLE IF EXISTS `shop_vr_order_snapshot`;
CREATE TABLE `shop_vr_order_snapshot` (
...
DROP TABLE IF EXISTS `shop_vr_order_statis`;
CREATE TABLE `shop_vr_order_statis` (
  `os_month` mediumint(9) unsigned NOT NULL DEFAULT '0' COMMENT '统计编号(年月)',
  `os_year` smallint(6) DEFAULT '0' COMMENT '年',
  `os_start_date` int(11) NOT NULL COMMENT '开始日期',
  `os_end_date` int(11) NOT NULL COMMENT '结束日期',
...
DROP TABLE IF EXISTS `shop_vr_refund`;
CREATE TABLE `shop_vr_refund` (
  `refund_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '记录ID',
...
DROP TABLE IF EXISTS `shop_vr_refund_detail`;
CREATE TABLE `shop_vr_refund_detail` (
  `refund_id` int(10) unsigned NOT NULL COMMENT '记录ID',
  `order_id` int(10) unsigned NOT NULL COMMENT '订单ID',
  `batch_no` varchar(32) NOT NULL COMMENT '批次号',
  `refund_amount` decimal(10,2) DEFAULT '0.00' COMMENT '退款金额',
...
DROP TABLE IF EXISTS `shop_waybill`;
CREATE TABLE `shop_waybill` (
...
CREATE TABLE `shop_web` (
  ...
  PRIMARY KEY (`web_id`)
) ENGINE=InnoDB AUTO_INCREMENT=123 DEFAULT CHARSET=utf8 COMMENT='页面模块表';

DROP TABLE IF EXISTS `shop_web_channel`;
CREATE TABLE `shop_web_channel` (
  ...
  KEY `gc_id` (`gc_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='商城频道表';
