$(function (){
    ...
    if(key){
        ...
        html += '<a href="javascript:void(0);" class="gotop">返回顶部</a>' + "</div>" + '<!--<div class="copyright">' + 'Copyright&nbsp;&copy;&nbsp;2005-2016 <a href="javascript:void(0);">随行商城V5 www.intexh_shop.com</a>版权所有' + "</div>--></div>";
      ...
      if (cart_count > 0) {
		...
		+'<li><a href="'+WapSiteUrl+'/tmpl/cart_list.html"><i class="cart"></i><sup></sup><p>购物车</p></a></li>'
