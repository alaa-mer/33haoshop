...
$(function(){
    ...
    if($("input[name=sc_id]").val()!=''){
    	$.ajax({
    		url:"http://localhost/intexh_shop/mobile/index.php?act=shop&op=shop_list&key=4&page="+pagesize+"&curpage=1"+'&sc_id='+$("input[name=sc_id]").val(),
    		type:'get',
    		dataType:'json',
    	...
    	$.ajax({
    		url:"http://localhost/intexh_shop/index.php?act=shop&op=shop_list&key=4&page="+pagesize+"&curpage=1"+'&keyword='+$("#keyword").val()+'&area_info='+area_info,
    		type:'get',
			dataType:'jsonp',
			jsonp:'callback',
    		success:function(result){
