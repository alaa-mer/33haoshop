  ...
  <form id="brand_form" method="post" name="form1" enctype="multipart/form-data">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="input-file-show"><span class="show"><a class="nyroModal" rel="gal" href="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_BRAND.'/'.$output['brand_array']['brand_pic']; ?>"> <i class="fa fa-picture-o" onMouseOver="toolTip('<img src=<?php echo UPLOAD_SITE_URL.'/'.ATTACH_BRAND.'/'.$output['brand_array']['brand_pic']; ?>>')" onMouseOut="toolTip()"></i></a></span><span class="type-file-box">
            <input class="type-file-file" nctype="file-brand-pic" id="_pic" name="_pic" type="file" size="30" hidefocus="true" title="点击前方预览图可查看大图，点击按钮选择文件并提交表单后上传生效">
      ...
      <dl class="row">
        ...
        <dd class="opt">
        <div class="input-file-show"><span class="show"><a class="nyroModal" rel="gal" href="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_BRAND.'/bgpic/'.$output['brand_array']['brand_bgpic']; ?>"> <i class="fa fa-picture-o" onMouseOver="toolTip('<img src=<?php echo UPLOAD_SITE_URL.'/'.ATTACH_BRAND.'/bgpic/'.$output['brand_array']['brand_bgpic']; ?>>')" onMouseOut="toolTip()"/></i> </a></span><span class="type-file-box">
            ...
            <input class="type-file-file" nctype="file-brand-bgpic" id="brand_filebgpic" name="brand_filebgpic" type="file" size="30" hidefocus="true" nc_type="change_brand_filebgpic" title="点击前方预览图可查看大图，点击按钮选择文件并提交表单后上传生效">
            </span></div>
          <span class="err"></span>
...
// 上传品牌大图类型
$('input[nctype="file-brand-bgpic"]').change(function(){
  ...
  $('input[nctype="file-brand-pic"]').change(uploadChange);
    ...
    (
      {
        ...
        success: function (data, status)
        {
          ...
          $('input[nctype="file-brand-pic"]').bind('change',uploadChange);
        },
        error: function (data, status, e)
        {
          alert('上传失败');$('input[nctype="file-brand-pic"]').bind('change',uploadChange);
        }
      }
    )
  };  
