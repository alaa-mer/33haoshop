    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <div class="input-file-show"><span class="type-file-box">
            ...
            <input class="type-file-file" nctype="file-brand-bgpic" id="brand_filebgpic" name="brand_filebgpic" type="file" size="30" hidefocus="true" title="点击前方预览图可查看大图，点击按钮选择文件并提交表单后上传生效">
            </span></div>
          <span class="err"></span>
