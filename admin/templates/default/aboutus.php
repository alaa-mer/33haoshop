  ...
  <div class="content">
    <div class="scroll switchbox" >
      <ul class="tema">
        <li>
          <h4>源码提供 - 随行商城</h4>
          <p>唯一官方网：<a href="http://www.intexh_shop.com" target="_blank">http://www.intexh_shop.com</a></p>
          <p>唯一淘宝店：<a href="http://www.intexh_shop.com" target="_blank">http://intexh_shopcom.taobao.com</a></p>
          <p>唯一旺旺名：intexh_shop</p>
    ...
    <div class="scrollbar switchbox" style="display: none;">
      <div class="law-notice">
        <p>程序来源：随行商城网店交流中心 <a href="http://www.intexh_shop.com" target="_blank">http://www.intexh_shop.com</a>。</p>
          感谢您选择随行商城B2B2C电商平台系统。希望我们的努力能为您提供一个高效快速和强大的企业级电子商务整体解决方案。</p>
        <p>随行商城B2B2C系统是根据网城天创系统进化而来！随行商城对本版本只用户学习和研究，您使用过程中产生的利益与随行商城(intexh_shop.com)无关，我们不负任何法律责任！</p>
    ...
    <div class="switchbox" style="display:none;" >
      <ul>
        ...
        <li>
          <h4>关注我们</h4>
          <p><?php echo $lang['dashboard_aboutus_website'];?> <a href="http://www.intexh_shop.com" target="_blank">http://www.intexh_shop.com</a></p>
