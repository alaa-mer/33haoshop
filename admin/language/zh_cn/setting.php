...
$lang['site_bank_account_notice']           = '用半角逗号","分隔项目，用半角冒号":"分隔标题和内容，例："银行:中国银行,币种:人民币,账号:xxxxxxxxxxx,姓名:intexhshop,开户行:中国银行北京分行"';
...
$lang['if_smtp_authentication']  = '使用SMTP协议发送的邮件地址，如 intexh_shop@163.com';
$lang['smtp_user_name']          = 'SMTP 身份验证用户名';
$lang['smtp_user_name_tip']      = '如 intexh_shop，如果使用163或126邮箱，填写完整，如 intexh_shop@163.com';
