...
<![endif]-->
<script src="<?php echo SHOP_RESOURCE_SITE_URL;?>/js/uploadImg.js"></script>
  ...
  <form method="post" id="goods_form" action="<?php if ($output['edit_goods_sign']) { echo urlShop('store_goods_online', 'edit_save_goods');} else { echo urlShop('store_goods_add', 'save_goods');}?>">
    ...
    <div class="ncsc-form-goods">
      ...
      <!-- 只有可发布虚拟商品才会显示 E -->
        <h3 id="demod">视频上传</h3>
        <dl>
            <dt nc_type="no_spec"><?php echo '视频名称'.$lang['nc_colon']?></dt>
            <dd>
                <p>
                    <input name="g_videoname" value="" type="text" class="text" />
                </p>
                <p class="hint">请填写上传视频名称。</p>
            </dd>

        </dl>
        <dl>
            <dt nc_type="no_spec"><?php echo '视频文件'.$lang['nc_colon']?></dt>
            <dd>
                <p>
                    <input name="g_videofile" value="" type="file"/>
                </p>
                <p class="hint">请填写上传视频名称。</p>
            </dd>
        ...
        <dl>
            <dt nc_type="no_spec"><?php echo '视频封面图'.$lang['nc_colon']?></dt>
            <dd>
                <p>
                    <input name="g_videopic" value="" type="file"/>
                </p>
                <p class="hint">请填写上传视频封面图片。</p>
            </dd>
