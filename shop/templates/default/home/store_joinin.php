...
<div class="banner">
  <div class="user-box">
    ...
    <div class="user-login">
      ...
      <div class="register">还没有成为我们的合作伙伴？ <a href="<?php echo MEMBER_SITE_URL;?>/index.php?act=login&op=register&ref_url=<?php echo SHOP_SITE_URL;?>/index.php?act=show_joinin" target="_blank">快速注册</a></div>
    </div>
    <?php } ?>
  </div>
